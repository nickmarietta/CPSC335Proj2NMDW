...
print("Example 1 [[2,1,1],[2,3,1],[3,4,1]], n = 4, k = 2  Output: ", network([[2,1,1],[2,3,1],[3,4,1]], 4, 2))
print("Example 2 [[1,2,1]], n = 2, k = 1  Output: ", network([[1,2,1]], 2, 1))
print("Example 3 [[1,2,1]], n = 2, k = 2  Output: ", network([[1,2,1]], 2, 2))
print("Example 4 [[1,3,1],[1,2,4],[4,2,1],[3,4,1]], n = 4, k = 1  Output: ", network([[1,3,1],[1,2,4],[4,2,1],[3,4,1]], 4, 1))